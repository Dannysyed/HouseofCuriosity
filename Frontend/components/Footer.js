...
import absharlogo from "../public/images/HouseLogo.png";
    ...
    <footer className="bg-gray-100 py-10 rounded-xl">
      <div className="container mx-auto flex flex-col lg:flex-row lg:justify-between lg:items-center space-y-6 lg:space-y-0 lg:space-x-8">
        ...
        <div className="lg:pr-8 space-y-3 ">
          <p>Contact: +91 6385920981</p>
          <p>Address: 3 Saint Laurent, Puducherry, 605001</p>
          <p className="mb-3">Email: theuntextbookproject@gmail.com</p>
          {/* <div className="flex gap-9 justify-start">
            <a
              href="tel:+918899037321"
              className="hover:text-blue-500 transition-colors duration-200"
            >
              <FiPhone size={24} />
            </a>
            <a
              href="mailto:abshartrust2021@gmail.com"
              className="hover:text-blue-500 transition-colors duration-200"
            >
              <FiMail size={24} />
            </a>
            <a
              href="https://www.instagram.com/abshar_trust"
              target="_blank"
            ...
            <a
              href="https://twitter.com/abshartrust?lang=en"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.linkedin.com/company/aabshar-source-of-humanity/"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-blue-500 transition-colors duration-200"
            >
          ...
          {/* <div className="flex justify-start lg:justify-start mt-4 space-x-4">
            ...
            <div className="flex items-center space-x-2">
              <div className="relative group">
                ...
                <span className="absolute bg-gray-800 text-white text-xs rounded-md py-1 px-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bottom-full left-1/2 transform -translate-x-1/2 -translate-y-2 group-hover:block hidden">
                  Partner 1
                </span>
              </div>
              <div className="relative group">
      ...
      <p className="text-center text-xs mt-6">
        &copy; 2023 HouseofCuriosity. All Rights Reserved.
      </p>
    </footer>
  );
};
